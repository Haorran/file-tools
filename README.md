...
<img src="docs/images/单目录查重.png" alt="单目录查重结果" width="700" />
> 查重结果：重复组与冗余占用统计
...
<img src="docs/images/单目录查重指纹复核.png" alt="移入前复核" width="700" />
> 移入前复核：指纹复核（mtime + 大小）或全文件哈希复核

<img src="docs/images/单目录查重暂存区.png" alt="暂存区" width="700" />
...
<img src="docs/images/多目录比较.png" alt="多目录比较" width="700" />
> 比较结果：文件清单差异与内容一致性
...
<img src="docs/images/文件索引.png" alt="文件索引" width="700" />
